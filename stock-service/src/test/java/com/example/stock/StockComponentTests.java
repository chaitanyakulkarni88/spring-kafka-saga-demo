...
public class StockComponentTests {
    ...
    void shouldAcceptOrderWhenStockAvailable() throws ExecutionException, InterruptedException, TimeoutException {
    ...
    void shouldRejectOrderWhenStockInsufficient() throws ExecutionException, InterruptedException, TimeoutException {
    ...
    @Test
    @org.junit.jupiter.api.Order(2)
    void shouldCommitStockReservationWhenOrderConfirmed() throws ExecutionException, InterruptedException, TimeoutException {
        Order o = new Order(1L, 1L, 1L, 10, 100);
