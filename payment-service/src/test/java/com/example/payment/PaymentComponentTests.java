...
public class PaymentComponentTests {
    ...
    void shouldAcceptOrderWhenMoneyAvailable() throws ExecutionException, InterruptedException, TimeoutException {
    ...
    void shouldRejectOrderWhenMoneyInsufficient() throws ExecutionException, InterruptedException, TimeoutException {
    ...
    @Test
    @org.junit.jupiter.api.Order(2)
    void shouldCommitMoneyReservationWhenOrderConfirmed() throws ExecutionException, InterruptedException, TimeoutException {
        Order o = new Order(1L, 1L, 1L, 10, 100);
